...
def generate_sync_path(total_points=100):
    ...
    waypoints = [
        # 1. DEPARTURE: Doha Port, Qatar
        (25.30, 51.55), # Doha Outbound

        # 2. TRANSIT TO YELLOW CORRIDOR: Straight line passing north of Qatar/UAE toward the center entrance
        ...
        # 4. RED ZONE (Iran High Risk Zone - Strait of Hormuz Centered Channel)
